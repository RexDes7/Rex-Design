...
export const approachPrinciples: ApproachPrinciple[] = [
  {
    ...
    description: 'Прежде чем рисовать, я изучаю бизнес, аудиторию и конкурентов. Дизайн работает, а не просто выглядит.',
    icon: 'insights',
  },
  {
    number: '02',
    title: 'Ясность вместо шума',
    description: 'Убираю лишнее, оставляю суть. Каждый элемент на странице знает, зачем он здесь.',
    icon: 'auto_awesome',
  },
  {
    number: '03',
    title: 'Партнёрство, а не подряд',
    description: 'Работаю как продакт-дизайнер вашего продукта: задаю вопросы, предлагаю, довожу до результата.',
    icon: 'handshake',
  },
]
...
export const processSteps: ProcessStepData[] = [
  {
    number: '01',
    title: 'Бриф',
    description: 'Знакомимся, обсуждаем задачу, цели и сроки. Я задаю много вопросов — это нормально.',
    duration: '1–2 дня',
  },
  {
    number: '02',
