          ...
          <div className={styles.biographySection}>
            ...
            <div className={styles.biographyContent}>
              <p className={styles.biographyTextLarge}>
                Я — МУЛЬТИДИСЦИПЛИНАРНЫЙ ДИЗАЙНЕР, КОТОРЫЙ ВЕРИТ В ПРАГМАТИЧНУЮ ЭСТЕТИКУ И ФУНКЦИОНАЛЬНУЮ ЧЕСТНОСТЬ. МОЯ РАБОТА — ЭТО СОЗДАТЬ ПРОДУКТ, КОТОРЫЙ ТОЧНО БУДЕТ В РЯДАХ ПЕРВОЙ КАТЕГОРИИ.
              </p>
